...
class AuthService {
  ...
  static Future<Map<String, dynamic>> getNodes() async {
    final response = await http.get(
        Uri.parse("${ApiConfig.baseUrl}/mobile/nodes"),
        headers: await _headers());
    return Map<String, dynamic>.from(_handle(response));
  }
  ...
  static Future<Map<String, dynamic>> updateProfile({
    ...
    if (locationEnabled != null) payload["locationEnabled"] = locationEnabled;
    if (nightMode != null) payload["nightMode"] = nightMode;
    if (notificationEnabled != null)
      payload["notificationEnabled"] = notificationEnabled;
    if (syncInterval != null) payload["syncInterval"] = syncInterval;
