  ...
  void updateFromApi(Map<String, dynamic> json) {
    try {
      ...
      if (rawLat != null) {
        ...
        if (parsedLat != null) {
          latitude =
              parsedLat; // Izinkan update nilai koordinat apa pun dari server
        }
      }
      if (rawLng != null) {
        ...
        if (parsedLng != null) {
          longitude =
              parsedLng; // Izinkan update nilai koordinat apa pun dari server
        }
      }
...
// 🚀 INITIAL ITEM UNTUK DITEMPATKAN DI PETA AWAL
